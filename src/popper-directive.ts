...
export class PopperController implements OnInit, OnChanges {
    ...
    show() {
        ...
        this.globalTouch = this.renderer.listen('document', 'touchend', this.hideOnClickOutsideHandler.bind(this));
    ...
    private clearEventListeners() {
        this.globalTouch && typeof this.globalTouch === 'function' && this.globalTouch();
